Machine Health & Maintenance Analytics

This project focuses on analyzing machine sensor data to monitor health, detect anomalies, and predict maintenance requirements using Excel, SQL, Python, and Power BI.

📌 Overview

The system processes machine-level data including temperature, vibration, pressure, and production metrics to:

Identify abnormal machine behavior
Predict defects and maintenance needs
Provide actionable insights through dashboards
⚙️ Tech Stack
Excel – Data preprocessing, health score calculation, trend analysis
SQL – Data querying, aggregation, and risk-level views
